...
INSERT INTO `employees` (`employeeID`, `employeeName`) VALUES (1,'Алексей Герасимов'),(2,'Юлиана Назимова'),(3,'Герман Ботов'),(4,'Ирина Антонова');
...
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('diagnostics.allow_i_s_tables','OFF','2019-11-09 15:31:19',NULL),('diagnostics.include_raw','OFF','2019-11-09 15:31:19',NULL),('ps_thread_trx_info.max_length','65535','2019-11-09 15:31:19',NULL),('statement_performance_analyzer.limit','100','2019-11-09 15:31:19',NULL),('statement_performance_analyzer.view',NULL,'2019-11-09 15:31:19',NULL),('statement_truncate_len','64','2019-11-09 15:31:19',NULL);
...
CREATE TABLE `tasks` (
  ...
  `taskExecutor` varchar(45) DEFAULT NULL,
...
INSERT INTO `tasks` (`id`, `taskShortName`, `taskDescription`, `taskExecutor`, `taskCreationDate`, `taskStatus`) VALUES (1,'Сходить погулять','Давно не был на улице, надо прогуляться.','Алексей Герасимов','2019-12-12','В процессе'),(2,'Купить продукты','Холодильник пуст, нужно закупиться.','Юлиана Назимова','2019-12-11','В процессе'),(3,'Сделать уроки','Сделай уроки после школы, иначе не будешь смотреть мультики.','Герман Ботов','2019-12-05','Выполнено'),(4,'Покормить кошку','Корм лежит в холодильнике на верхней полке.','Ирина Антонова','2019-11-19','Выполнено'),(5,'Выгулять собаку','До школы выгуляй собаку, мне некогда.','Герман Ботов','2019-12-13','В процессе'),(6,'Сходить в кино','Не забыть, что билеты на завтра куплены. Сеанс в 18:30.','Алексей Герасимов','2019-12-13','В процессе'),(7,'Выкинуть мусор','Куча мусора скопилась и лежит у двери. Выкинь как вернёшься.','Юлиана Назимова','2019-11-19','Выполнено'),(8,'Купить лекарства','Закончились лекарства. Сходи в аптеку. ','Ирина Антонова','2019-11-10','Выполнено'),(9,'Провести генеральную уборку','Дома совсем грязно. Уберись.','Алексей Герасимов','2019-12-05','В процессе'),(10,'Съездить с кошкой к ветеринару','Кажется, с ней что-то не то. Отвези в ветклинику.','Юлиана Назимова','2019-12-10','В процессе');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_IDs` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_IDs`()
BEGIN
SET @num := 0;
UPDATE tasks SET id = @num := (@num+1) where id>0;
...
-- Dump completed on 2019-12-12 14:03:16
